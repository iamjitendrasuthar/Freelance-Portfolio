              ...
              <table className="w-full text-left border-collapse min-w-[800px]">
                <thead>
                  <tr className="bg-white/5 border-b border-white/10 text-gray-400 text-xs sm:text-sm uppercase tracking-wider">
                    ...
                    <th className="p-4 sm:p-5 font-semibold">Client Details</th>
                    <th className="p-4 sm:p-5 font-semibold">Subject</th>
                    <th className="p-4 sm:p-5 font-semibold">Message</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-white/5">
                  {isInquiriesLoading ? (
                    ...
                    inquiries.map((inquiry) => (
                      <tr
                        ...
                        className="hover:bg-white/[0.02] transition-colors"
                      >
                        <td className="p-4 sm:p-5 text-gray-400 text-xs sm:text-sm whitespace-nowrap">
                        ...
                        <td className="p-4 sm:p-5 text-emerald-400 text-xs sm:text-sm font-medium">
                          {inquiry.subject}
                        </td>
                        <td className="p-4 sm:p-5 max-w-[250px]">
                          <p
