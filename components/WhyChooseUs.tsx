...
const WhyChooseUs = () => {
  return (
    <section className="py-20 md:py-32 bg-[#051814] text-white relative overflow-hidden">
      {/* Background Glow Effects */}
      <div className="absolute top-[20%] left-[-10%] w-[50%] h-[50%] bg-emerald-500/10 blur-[120px] rounded-full pointer-events-none" />
      <div className="absolute bottom-[-10%] right-[-10%] w-[40%] h-[40%] bg-teal-500/10 blur-[100px] rounded-full pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 text-center relative z-10">
        ...
        <FadeIn delay={0.2} className="relative max-w-5xl mx-auto">
          ...
          <div className="aspect-[4/3] sm:aspect-[16/9] md:aspect-[21/9] rounded-[2rem] overflow-hidden relative border border-white/10 shadow-2xl bg-[#1A332E]/30">
            <img
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-[#051814] via-[#051814]/20 to-transparent" />
            <div className="absolute inset-0 bg-gradient-to-r from-[#051814]/80 via-transparent to-[#051814]/80" />
          </div>
          ...
          <motion.div
            ...
            className="absolute top-4 sm:top-8 md:top-12 left-2 sm:left-8 md:-left-8 bg-[#0a241d]/90 backdrop-blur-xl border border-white/10 p-3 sm:p-4 rounded-xl sm:rounded-2xl shadow-[0_8px_32px_rgba(16,185,129,0.15)] flex items-center gap-3 sm:gap-4 z-20 scale-85 sm:scale-100 origin-top-left"
          >
